...
from mvce.mesh import assign_height_limits, build_mesh, building_outline, wall_setback_ring
from mvce.optimizer import OptimizeOptions, optimize
...
def test_voxel_beats_uniform_scaling_on_floor_area():
    ...
    from mvce.mesh import build_mesh as _build
    from mvce.optimizer import _apply_coverage_cap
    from mvce.shadow_index import build_shadow_index
...
def test_roof_pattern_result_is_independently_compliant():
    from mvce.regulations.shadow import compute_shadow_hours
