"""JavaScript版のMVCEエンジンがPython版と同じ答えを出すことの検証。
...
from mvce.isochrone import _default_grid_margin_m, site_isochrones
...
from mvce.shadow_index import grid_shadow_hours
