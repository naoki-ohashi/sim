...
from mvce.io.dxf_site import SiteImportError, read_site_plan
from mvce.io.drawing import write_dxf
from mvce.io.viewer3d import build_html, write_html
...
def test_reversed_polyline_is_normalised_to_ccw(tmp_path):
    ...
    plan = read_site_plan(str(path))
    from mvce.geometry import polygon_signed_area
