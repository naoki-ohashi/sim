/* MVCE 等時間日影図（等時間日影線） — マーチングスクエア法によるJS実装
 *
 * Python版 mvce/isochrone.py（+ mvce/shadow_index.py の grid_shadow_hours）の
...
(function (global) {
  ...
  global.MvceIsochrone = { defaultGridMarginM, gridShadowHours, computeIsochrones, siteIsochrones };
